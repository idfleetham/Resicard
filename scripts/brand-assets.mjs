...
//
// The mark occupies 62% of the tile. iOS and the manifest's "any" purpose crop
// nothing, but the tile still needs air, or the scallop tips run into the rounded
// corners and the shape reads as a texture rather than a stamp.
const ICON_INSET = 0.19;
