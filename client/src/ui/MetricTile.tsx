...
export default function MetricTile({ label, value, delta, icon }: { label: string; value: React.ReactNode; delta?: string; icon?: React.ReactNode }) {
  return (
    <motion.div whileHover={{ y: -2 }} className="bg-card border border-white/20 shadow-lg shadow-white/10 hover:shadow-xl hover:shadow-white/15 hover:border-white/30 transition rounded-xl p-5">
